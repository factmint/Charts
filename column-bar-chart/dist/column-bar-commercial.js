...
define('columnBarUtils',['Tooltip', 'key', 'config'],

function(Tooltip, Key, Config) {
	...
	var createTooltip = function(paper, x, y, position, label, value, group) {
		var tooltipObject = new Tooltip(paper, 'fm-column-bar-tooltip', 'fm-datum-color-overflow');
        var tooltip = tooltipObject.render(label, value)
            .addClass('with-fill');
...
require(['render'], function(render) {
	...
	var tables = document.querySelectorAll('table.fm-column-bar');
