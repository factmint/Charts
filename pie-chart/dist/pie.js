...
define('G.move',['svg-js'], function(SVG) {
	SVG.extend(SVG.G, {
		move: function(x, y) {
...
return function(table) {
	...
	var drawSVGNode = function(redraw) {
		...
		renderer(
			(options.disableSpillover) ? 0 : Configuration.SPILLOVER_LEFT,
			(options.disableSpillover) ? 0 : Configuration.SPILLOVER_TOP,
			primaryWidth,
			primaryHeight,
			options,
			table,
